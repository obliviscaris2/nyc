        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-8">
                    @if ($row)
                    @if ($row->id ==1)
                    <h4>Access denied,You can't delete the Admin</h4> 
                   ...
                   @else
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input disabled value="{{ $row->name }}" id="name" type="text" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input disabled value="{{ $row->email }}" id="email" type="text" class="form-control"
