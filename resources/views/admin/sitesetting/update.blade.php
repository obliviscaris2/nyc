      ...
      <div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <input type="text" name="govn_name" class="form-control"
               value="{{ $sitesetting->govn_name ?? ''}}"  placeholder="Government Name">
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Ministry Name</label>
            <input type="text" name="ministry_name" class="form-control" value="{{ $sitesetting->ministry_name ?? ''}}"
                 placeholder="Ministry Name">
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Department Name</label>
            <input type="text" name="department_name" class="form-control" value="{{ $sitesetting->department_name ?? ''}}"
        ...
        <div class="form-group">
            ...
            <input type="text" name="office_address" class="form-control" value="{{ $sitesetting->office_address ?? ''}}"
                 placeholder="Address">
        </div>

        <div class="form-group">
            <label for="exampleInputEmail1">Office Contact</label>
            <input type="text" name="office_contact" class="form-control" value="{{ $sitesetting->office_contact ?? ''}}"
